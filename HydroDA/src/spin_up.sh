...
if [ $opt = "dam" ] || [ $opt = "all" ];then
     LDAMOUT=".FALSE."                      # .TRUE. to activate reservoir operation (under development)
fi # Moiz [Conditional was open before; caused syntax error]
...
CVARSOUT="rivout,rivsto,sfcelv,outflw,storge,fldout,fldsto" #"rivout,rivsto,sfcelv,outflw,storge,fldout,fldsto,daminf,damsto,flddph,fldare" # list output variable (comma separated) # Moiz: Changed following /cluster/data6/menaka/HydroDA_Dam/src/spin_up_v410.sh 
