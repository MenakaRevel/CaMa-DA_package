...
CVARSOUT="rivout,rivsto,sfcelv,outflw,storge,fldout,fldsto" #"rivout,rivsto,sfcelv,outflw,storge,fldout,fldsto,daminf,damsto,flddph,fldare" # list output variable (comma separated) # Moiz
